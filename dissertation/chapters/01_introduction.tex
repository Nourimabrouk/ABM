...
This dissertation addresses a fundamental question that bridges social psychology, network science, and computational sociology: \textbf{How can individual-level changes in tolerance resulting from hypothetical interventions spread and persist within social networks to increase interethnic cooperation over time, given different intervention designs?}

This overarching research question decomposes into three interconnected sub-questions that structure the empirical investigation:

\begin{researchquestion}
\textbf{RQ1: Network Diffusion Mechanisms} \\
Through what social influence mechanisms does tolerance spread among ethnic majority friends in educational settings, and under what conditions do attraction-repulsion dynamics facilitate versus impede tolerance diffusion?
\end{researchquestion}

\begin{researchquestion}
\textbf{RQ2: Tolerance-Cooperation Pathway} \\
How does increased tolerance translate into greater interethnic cooperation, and what role does the expansion of individuals' "radius of trust" play in mediating this relationship?
\end{researchquestion}

\begin{researchquestion}
\textbf{RQ3: Intervention Design Optimization} \\
What intervention design parameters—including target selection strategies (centrality-based vs. random), intervention intensity, delivery patterns (clustered vs. dispersed), and contagion complexity (simple vs. complex)—maximize sustained improvements in interethnic cooperation?
\end{researchquestion}
