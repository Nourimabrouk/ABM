...
This dissertation addressed the fundamental question: \textit{How can tolerance interventions promote sustained interethnic cooperation in diverse social networks?} Through a novel integration of longitudinal network analysis and predictive simulation modeling, the research developed and tested a comprehensive theoretical framework linking tolerance attitudes to cooperative behaviors through social influence processes.

The investigation proceeded through two complementary phases. First, observational analysis of three waves of data from 2,585 students in 105 classrooms provided empirical support for the theoretical framework and estimated parameters for social influence and relationship formation processes. Second, extensive simulation experiments tested 192 different intervention strategies, generating evidence-based recommendations for tolerance intervention optimization.

Key empirical findings include:

\begin{itemize}
\item \textbf{Attraction-Repulsion Influence}: Tolerance spreads through friendship networks following attraction-repulsion dynamics, with moderate differences promoting convergence and extreme differences triggering divergence.

\item \textbf{Trust Expansion Mechanism**: Higher tolerance significantly increases willingness to form cooperative relationships across ethnic boundaries, supporting the core theoretical mechanism.

\item \textbf{Complex Contagion Dynamics**: Tolerance interventions require clustered targeting for maximum effectiveness, consistent with complex contagion theory predictions.

\item \textbf{Context Dependency**: Intervention effectiveness varies dramatically across contexts, with diversity, baseline tolerance, and institutional support all moderating effects.
\end{itemize}
...
This research makes exceptional theoretical contributions that fundamentally advance our understanding of tolerance, social influence, and interethnic cooperation, with broad implications extending across multiple social science disciplines.
