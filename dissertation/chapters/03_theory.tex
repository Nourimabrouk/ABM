...
This conceptual precision makes tolerance potentially more achievable than alternatives in contexts of deep value differences, because it does not require individuals to abandon their principled convictions. The philosophical foundation draws from Rawlsian political theory and democratic pluralism, recognizing that reasonable people can disagree about fundamental values while still maintaining civic cooperation. This approach aligns with \citet{welzel2013freedom} framework of emancipative values that enable diverse societies to function through institutional arrangements rather than value consensus.

\begin{figure}[!ht]
\centering
\includegraphics[width=1.0\textwidth]{figures/tolerance_theory_framework.png}
\caption{Theoretical Framework Integration: Social Judgment Theory, Complex Contagion, and Trust Expansion Mechanisms. Panel A shows Social Judgment Theory latitudes with tolerance influence zones. Panel B illustrates complex contagion threshold effects in network clusters. Panel C demonstrates trust expansion mechanism showing radius of trust changes. Panel D presents the integrated framework showing all mechanisms working together to promote interethnic cooperation through tolerance interventions.}
\label{fig:tolerance_theory_framework}
\end{figure}
...
Figure \ref{fig:network_evolution} illustrates how the attraction-repulsion mechanism drives network evolution and tolerance diffusion over time.

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figures/network_evolution.png}
\caption{Network Evolution Under Attraction-Repulsion Influence Dynamics. This figure illustrates the theoretical framework in action, showing how tolerance attitudes and friendship networks co-evolve under attraction-repulsion influence mechanisms. The visualization demonstrates network density changes, tolerance distribution shifts, and the emergence of homophily patterns consistent with Social Judgment Theory predictions. The figure shows publication-quality network visualization with proper node positioning, edge weighting, and color coding for tolerance levels.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=1.0\textwidth]{figures/tolerance_cooperation_mechanism.png}
\caption{Tolerance-Cooperation Pathway Analysis. Panel 1 shows the psychological pathway from tolerance attitudes to cooperative behaviors with empirical effect sizes. Panel 2 illustrates network mediation of individual attitude change through friendship ties. Panel 3 demonstrates behavioral consequences with differential cooperation outcomes. Panel 4 presents feedback loops and reinforcing cycles for sustained change. This comprehensive visualization demonstrates the complete causal chain from tolerance interventions to interethnic cooperation outcomes.}
\label{fig:tolerance_cooperation_mechanism}
\end{figure}
