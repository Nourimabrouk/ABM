...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{../outputs/visualizations/rigorous_saom_analysis}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/tolerance_cooperation_plot}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/complex_contagion_plot}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/meta_analysis_plot}
