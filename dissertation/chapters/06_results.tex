...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{../outputs/visualizations/tolerance_intervention_comprehensive}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/proportion_effects_plot}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/intensity_strategy_plot}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/temporal_dynamics_plot}
...
\textbf{High-Diversity Contexts** (IQV > 0.8):
\begin{itemize}
...
\textbf{Low-Diversity Contexts** (IQV < 0.5):
\begin{itemize}
...
\textbf{Low-Tolerance Contexts** (baseline < 3.0):
\begin{itemize}
